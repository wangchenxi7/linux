...
asmlinkage int sys_get_swap_stats(void)
{
	...
	pr_warn("%s, Major fault: %lu us, Minor fault: %lu us \n, 	\
	       Swap out latency: %lu us, 				\
	       tlb flush latency #1: %lu us, tlb flush latency #2: %lu us\n",
		__func__,
	       swap_major_dur, swap_minor_dur,
	       swapout_latency, swapout_tlb_flush_1, swapout_tlb_flush_2);
